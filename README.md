...
## **Статус:**
На данный момент находится в статусе переписывания. Для формирования представления об изначальной структуре кода программы ознакомтесь со старой [курсовой работой](https://github.com/sk-mm27/Coursework).
